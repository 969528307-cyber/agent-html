...
This is why To Play Claw separates the ecosystem into Agents, Tools, Skills, MCPs, and Workflows. The Agent is the user-facing surface. The tools and instructions are what make it useful.
