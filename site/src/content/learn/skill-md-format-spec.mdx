...
subtitle: "Based on the public format from anthropics/skills (136K★) and 51 Skill repos indexed in 2playclaw.com"
status: "published"
topic: "skill"
path: "start"
order: 9
...
summaryBullets:
  ...
  - "51 Skill repos are indexed in 2playclaw.com, covering code, design, security, and docs"
...
All of the above are available on the 2playclaw.com type/skill page.

## Data Sources

Public format from the anthropics/skills repository: github.com/anthropics/skills. 2playclaw.com published Skill data from src/content/tools (type=skill).
