...
subtitle: "Based on the public format from anthropics/skills (136K★) and 51 Skill repos indexed in To Play Claw"
status: "published"
topic: "skill"
path: "start"
order: 9
...
summaryBullets:
  ...
  - "51 Skill repos are indexed in To Play Claw, covering code, design, security, and docs"
...
All of the above are available on the To Play Claw type/skill page.

## Data Sources

Public format from the anthropics/skills repository: github.com/anthropics/skills. To Play Claw published Skill data from src/content/tools (type=skill).
